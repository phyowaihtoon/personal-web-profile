...
description: Build and maintain a personal website backend using TypeScript, Express, Prisma, SQLite for local development and testing, PostgreSQL for production, JWT auth, validation, migrations, API versioning, and Jest/Supertest testing.
---
...
- Use PostgreSQL for production.
- Keep Prisma schema compatible across both providers where possible.
...
2. Add Prisma with SQLite for local/test and PostgreSQL for production.
...
8. Add Jest and Supertest test setup.
