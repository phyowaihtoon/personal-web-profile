    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: 'home',
            element: <CmsEditorPage title="Home CMS" description="Hero, featured projects, latest posts, and section visibility." queryKey="admin-home" load={adminApi.getHome} mode="singleton" save={adminApi.updateHome} />,
          },
          {
            path: 'about',
            element: <CmsEditorPage title="About CMS" description="Biography, learning journey, and timeline content." queryKey="admin-about" load={adminApi.getAbout} mode="singleton" save={adminApi.updateAbout} />,
          },
          {
            path: 'experience',
            element: (
          ...
          {
            path: 'settings',
            element: <CmsEditorPage title="Site settings" description="Global site title, contact information, social links, and SEO defaults." queryKey="admin-settings" load={adminApi.getSettings} mode="singleton" save={adminApi.updateSettings} />,
          },
        ],
      },
    ],
